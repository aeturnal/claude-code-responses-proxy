...
must_haves:
  truths:
    - "Operator can configure OpenAI credentials/base URL via env vars without code changes"
    - "Given an Anthropic model name, the proxy deterministically resolves the OpenAI model used upstream"
  artifacts:
