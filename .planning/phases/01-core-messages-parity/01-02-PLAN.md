...
<task type="auto">
  ...
  <action>
    ...
    - Implement map_anthropic_request_to_openai(request: MessagesRequest) that:
      ...
      - Maps max_tokens -> max_output_tokens on the OpenAI request when provided.
  ...
  <done>Anthropic request objects deterministically produce OpenAI Responses request payloads, including max_tokens mapping to max_output_tokens.</done>
</task>
