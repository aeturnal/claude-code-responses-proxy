# Requirements Archive: v1.0 MVP Compatibility
...
- [x] **TOK-01**: `/v1/messages/count_tokens` returns token counts aligned with OpenAI billing.
- [x] **TOK-02**: Token counting normalizes system/tool content consistently with request mapping.
